...
/*
  ...
  object. Also remember that scopes do not derive from Object.prototype, so if
  you want to call hasOwnProperty on them, you have to use this clumsy 
  expression:

  Object.prototype.hasOwnProperty.call(scope, name);
*/

let { specialForms, run, evaluate, topScope } = require('./12_language_alt.js');
let { define } = specialForms;
...
specialForms.set = (args, scope) => {
  ...
  while (Object.getPrototypeOf(obj) !== null) {
    if (Object.prototype.hasOwnProperty.call(obj, binding)) {
      obj[binding] = value;
      return value;
    } 
    obj = Object.getPrototypeOf(obj);
  }
  throw new ReferenceError("Cannot assign value to non-existing variable.");
};
...
// run(`set(quux, true)`); //=> throw ReferenceError, since quux doesn't exist.