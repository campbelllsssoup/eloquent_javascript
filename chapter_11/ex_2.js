// Exercise 11-2: Building Promise.all : NOT DONE...
...
/*
  ...
  fail again, and further calls to the functions that resolve it are ignored. 
...
Promise_all([soon(1), Promise.reject("X"), soon(3)])
  ...
  .catch(error => {
    console.log(`This should read 'X': ${error}`)
  });