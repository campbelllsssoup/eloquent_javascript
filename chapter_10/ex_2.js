// Exercise 10-2: Roads Module : DONE!!!

/*
    Write a CommonJS module, based on the example from Chapter 7, that contains the
    array of roads and exports the graph data structure (adjacency lists) representing
    them as 'roadGraph'. It should depend on a module ./graph, which exports a function
...
let { buildGraph, addEdges } = require('./graph');
...
// console.log(buildGraph(roads)); // WORKS
